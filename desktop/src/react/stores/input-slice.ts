...
export interface InputSlice {
  ...
  inputEditorResetTrigger: number;
...
export const createInputSlice = (
  ...
  requestInputEditorReset: () =>
    set((s) => ({ inputEditorResetTrigger: s.inputEditorResetTrigger + 1 })),
