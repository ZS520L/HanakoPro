...
export interface PlatformApi {
  ...
  openTerminal?(arg?: string | { cwd?: string; focusId?: string; newTab?: boolean }): void;
  onTerminalNewTab?(callback: (data: { cwd?: string }) => void): void | (() => void);
  onTerminalFocusTab?(callback: (data: { id: string }) => void): void | (() => void);
