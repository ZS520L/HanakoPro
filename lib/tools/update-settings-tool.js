...
const SETTINGS_REGISTRY = {
  ...
  inline_diff: {
    type: "toggle",
    get label() { return t("toolDef.updateSettings.inlineDiff"); },
    get description() { return t("toolDef.updateSettings.inlineDiffDesc"); },
    searchTerms: ["diff", "inline diff", "差异", "编辑慢", "slow edit", "对比"],
    get: (engine, _agent) => String(engine.preferences.getInlineDiff()),
    apply: (engine, _agent, v) => engine.setInlineDiff(v),
  },
  locale: {
    type: "list",
